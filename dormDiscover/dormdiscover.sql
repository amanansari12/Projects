...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2023 at 06:09 AM
...
(74, 'Nice Room\r\n', 1, 'EpicOa8v', '2023-08-12 08:11:19');
...
INSERT INTO `confirmbooking` (`Booking_id`, `tenant_user_id`, `tenant_name`, `tenant_contact`, `room_id`, `room_address`, `room_price`, `host_id`, `timeStamp`) VALUES
(48, 1, 'Aman Ansari', 2147483647, 'EpicOa8v', 'Haji Hussaini Chowk, Harmu', 5000, 1, '2023-08-12 08:10:06'),
(49, 16, 'Farhan', 2147483647, 'QRl4pRDc', 'Bypass Road, Harmu', 3000, 1, '2023-08-13 09:40:48');
...
('EpicOa8v', 'Haji Hussaini Chowk', 1, 5000, 1, 'true', 'false', 'false'),
('QRl4pRDc', 'Bypass Road', 1, 3000, 1, 'true', 'false', 'false');
...
(1, 'Aman Ansari', '8877225568', 'aman12', '$2y$10$D4inyuYsTcgT3AF8Fl.zGecCQvI1qQsRhTo.KFpWTuH7US/48NEkW'),
(16, 'Farhan', '8785154613', 'farhan12', '$2y$10$4ChqoEA0P6uXqPb8QKriWuG0w4jqQJJLHzhjyHlDMkPe7ovtw1b7G');
...
--
ALTER TABLE `comment`
  MODIFY `comment_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `favourite`
  MODIFY `fav_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
